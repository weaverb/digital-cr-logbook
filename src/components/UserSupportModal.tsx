        ...
        <div className="p-5 bg-slate-950 border border-slate-800 rounded-2xl space-y-4 shadow-lg hover:border-slate-700 transition-colors">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <span className="text-xs font-mono font-bold uppercase tracking-wider px-2 py-0.5 bg-cyan-500/10 text-cyan-400 border border-cyan-500/30 rounded-full whitespace-nowrap">
                Bug Reports
              </span>
              <span className="text-xs font-mono font-bold uppercase tracking-wider px-2 py-0.5 bg-cyan-500/10 text-cyan-400 border border-cyan-500/30 rounded-full whitespace-nowrap">
                Feature Requests
          ...
          <div className="flex items-center justify-end pt-1">
            <a
              ...
              className="px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white rounded-xl text-sm font-bold flex items-center gap-1.5 transition-colors shadow-md"
            >
