  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      ...
      >
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-100 flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 font-mono text-sm">
                  v{APP_VERSION}
                </span>
              </h2>
              <p className="text-sm text-slate-400">Need help or encountered a bug? Choose your preferred contact method below.</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 bg-emerald-950/30 border border-emerald-500/30 rounded-xl flex items-start space-x-3 text-sm text-emerald-200/90 leading-relaxed">
        ...
        <div className="p-5 bg-gunmetal-950 border border-slate-800 rounded-2xl space-y-3.5 shadow-lg">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Copy this details block to include with either GitHub Issue or Email support.</p>
              </div>
            </div>
            <button
              onClick={handleCopySysInfo}
              className="px-3.5 py-2 bg-cyan-500 hover:bg-cyan-400 text-cyan-950 rounded-xl text-sm font-bold flex items-center justify-center gap-1.5 transition-colors shadow-md shrink-0"
          ...
          <div className="space-y-1.5">
            ...
            <pre className="p-3 bg-slate-950 border border-slate-800 rounded-xl text-sm font-mono text-slate-300 leading-relaxed overflow-x-auto selection:bg-slate-700 selection:text-slate-100">
{systemDetailsText}
            </pre>
          </div>
        </div>
        ...
        <div className="p-5 bg-gunmetal-950 border border-slate-800 rounded-2xl space-y-4 shadow-lg hover:border-slate-700 transition-colors">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <span className="text-xs font-mono font-bold uppercase tracking-wider px-2 py-0.5 bg-purple-500/10 text-purple-400 border border-purple-500/30 rounded-full whitespace-nowrap">
                Bug Reports
              </span>
              <span className="text-xs font-mono font-bold uppercase tracking-wider px-2 py-0.5 bg-purple-500/10 text-purple-400 border border-purple-500/30 rounded-full whitespace-nowrap">
                Feature Requests
          ...
          <div className="flex items-center justify-end pt-1">
            <a
              ...
              className="px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white rounded-xl text-sm font-bold flex items-center gap-1.5 transition-colors shadow-md"
            >
        ...
        <div className="p-5 bg-gunmetal-950 border border-slate-800 rounded-2xl space-y-4 shadow-lg hover:border-slate-700 transition-colors">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono font-bold uppercase tracking-wider px-2 py-0.5 bg-amber-500/10 text-amber-400 border border-amber-500/30 rounded-full">
              Direct Contact
            </span>
          </div>
          ...
          <div className="p-3 bg-slate-900 border border-slate-800 rounded-xl flex items-center justify-between text-sm font-mono text-amber-300">
            <span className="truncate">{supportEmail}</span>
            <button
              onClick={handleCopyEmail}
              className="px-2.5 py-1 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded border border-slate-700 font-sans text-sm flex items-center gap-1 transition-colors shrink-0 ml-2"
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <a
              ...
              className="px-4 py-2 bg-amber-500 hover:bg-amber-400 text-amber-950 rounded-xl text-sm font-bold flex items-center gap-1.5 transition-colors shadow-md"
            >
        ...
        <div className="flex justify-end pt-2 border-t border-slate-800">
          <button
            onClick={onClose}
            className="px-5 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl text-sm font-semibold transition-colors"
          >
            Close Window
          </button>
        </div>
