      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl w-full max-w-xl flex flex-col shadow-2xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-sm">
          ...
          <div className="pt-4 border-t border-slate-800 flex items-center justify-end space-x-3">
            ...
            <button
              type="submit"
              className="px-5 py-2 bg-amber-400 hover:bg-amber-300 text-amber-950 font-bold rounded text-sm transition-colors shadow-lg shadow-amber-950/20 flex items-center gap-1.5"
            >
